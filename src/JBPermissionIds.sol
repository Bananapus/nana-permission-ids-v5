...
library JBPermissionIds {
    ...
    uint256 internal constant ADD_ACCOUNTING_CONTEXTS = 19; // Permission to call `JBMultiTerminal.addAccountingContextsFor`.
    ...
    uint256 internal constant SET_BUYBACK_TWAP = 24; // Permission to call `JBBuybackHook.setTwapWindowOf` and `JBBuybackHook.setTwapSlippageToleranceOf`.
    ...
    uint256 internal constant ADD_SWAP_TERMINAL_TWAP_PARAMS = 27; // Permission to call `JBSwapTerminal.addTwapParamsFor`.
